    ...
    internal func setConstraints() {
        ...
        if let customView = customView {
            ...
            if shouldShowTitleLabel() {
                ...
                contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-10-[\(ViewStrings.titleLabel)]-10-|", options: [], metrics: nil, views: [ViewStrings.titleLabel:titleLabel]))
            } else {
            ...
            if shouldShowDescriptionLabel() {
                ...
                contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-10-[\(ViewStrings.descriptionLabel)]-10-|", options: [], metrics: nil, views: [ViewStrings.descriptionLabel: descriptionLabel]))
            } else {
